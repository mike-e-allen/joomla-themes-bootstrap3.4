				...
				<div class="userdata">
					<div id="form-login-username" class="form-group">
							...
							<?php if (!$params->get('usetext')) : ?>
									...
									<div class="input-group-addon"><span class="glyphicon glyphicon-user hasTooltip" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"></span></div>
					...
					<div id="form-login-password" class="form-group">
							...
							<?php if (!$params->get('usetext')) : ?>
									...
									<div class="input-group">
									<div class="input-group-addon"><span class="glyphicon glyphicon-lock hasTooltip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"></span></div>
						...
						<div class="controls">
							<?php if (!$params->get('usetext')) : ?>
								<div class="input-prepend input-append">
									...
									<div class="input-group">
									<div class="input-group-addon"><span class="glyphicon glyphicon-star hasTooltip" title="<?php echo JText::_('JGLOBAL_SECRETKEY'); ?>"></span></div>
					...
					<div id="form-login-remember" class="form-group checkbox">
						<label for="modlgn-remember"><input id="modlgn-remember" type="checkbox" name="remember" value="yes"/><?php echo JText::_('MOD_LOGIN_REMEMBER_ME') ?>
						</label>
					</div>
					<?php endif; ?>
					<div id="form-login-submit" class="form-group">
						<button type="submit" tabindex="0" name="Submit" class="btn btn-default btn-primary"> <?php echo JText::_('JLOGIN') ?> </button>						
					</div>
					<?php
